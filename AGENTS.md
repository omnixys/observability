...
Omnixys observability package for TypeScript (OTel, metrics, structured logging).

- Repository path: `packages/ts/observability` (relative to the Omnixys root)
...
Tracing/metrics primitives shared across services.
